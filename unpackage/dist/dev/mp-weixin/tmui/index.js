...
let $tm = {
  tabBar,
  pages,
  globalNavStyle: (PageJsonInit == null ? void 0 : PageJsonInit.globalStyle.navigationStyle) ?? "",
...
const tmui = {
  ...
  install: (app, options = {}) => {
    ...
    function linsInko(obj) {
      ...
      ((_a2 = options.router) == null ? void 0 : _a2.useTmRouterBefore) ? (_b = options.router) == null ? void 0 : _b.useTmRouterBefore(obj) : tmui_tool_router_index.useTmRouterBefore();
    }
